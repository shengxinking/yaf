 ...
 * well
 */
#ifndef YAF_NEW_FIXBUF
static fbInfoElement_t yaf_info_elements[] = {
    FB_IE_INIT("initialTCPFlags", CERT_PEN, 14, 1, ER),
    FB_IE_INIT("unionTCPFlags", CERT_PEN, 15, 1, ER),
    ...
    FB_IE_INIT("firstPacketBanner", CERT_PEN, 38, FB_IE_VARLEN,
               FB_IE_F_REVERSIBLE),
    FB_IE_INIT("secondPacketBanner", CERT_PEN, 39, FB_IE_VARLEN,
               FB_IE_F_REVERSIBLE),
    FB_IE_INIT("flowAttributes", CERT_PEN, 40, 2, ER),
    ...
    FB_IE_INIT("yafFlowKeyHash", CERT_PEN, 106, 4, ER),
    /* flow stats */
    FB_IE_INIT("smallPacketCount", CERT_PEN, 500, 4, ER),
    FB_IE_INIT("nonEmptyPacketCount", CERT_PEN, 501, 4, ER),
    FB_IE_INIT("dataByteCount", CERT_PEN, 502, 8, ER),
    FB_IE_INIT("averageInterarrivalTime", CERT_PEN, 503, 8, ER),
    FB_IE_INIT("standardDeviationInterarrivalTime", CERT_PEN, 504, 8, ER),
    FB_IE_INIT("firstNonEmptyPacketSize", CERT_PEN, 505, 2, ER),
    FB_IE_INIT("maxPacketSize", CERT_PEN, 506, 2, ER),
    FB_IE_INIT("firstEightNonEmptyPacketDirections", CERT_PEN, 507, 1, ER),
    FB_IE_INIT("standardDeviationPayloadLength", CERT_PEN, 508, 2, ER),
    FB_IE_INIT("tcpUrgentCount", CERT_PEN, 509, 4, ER),
    FB_IE_INIT("largePacketCount", CERT_PEN, 510, 4, ER),
    FB_IE_NULL
};
#else
...
static fbInfoElement_t yaf_info_elements[] = {
    ...
    FB_IE_INIT_FULL("averageInterarrivalTime", CERT_PEN, 503, 8,
                    ER | FB_UNITS_MILLISECONDS, 0, 0, FB_DT_MILSEC, NULL),
...
static fbInfoElement_t yaf_dpi_info_elements[] = {
    FB_IE_INIT("httpServerString", CERT_PEN, 110, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpUserAgent", CERT_PEN, 111, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpGet", CERT_PEN, 112, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpConnection", CERT_PEN, 113, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpVersion", CERT_PEN, 114, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpReferer", CERT_PEN, 115, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpLocation", CERT_PEN, 116, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpHost", CERT_PEN, 117, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpContentLength", CERT_PEN, 118, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAge", CERT_PEN, 119, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAccept", CERT_PEN, 120, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAcceptLanguage", CERT_PEN, 121, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpContentType", CERT_PEN, 122, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpResponse", CERT_PEN, 123, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpCookie", CERT_PEN, 220, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpSetCookie", CERT_PEN, 221, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAuthorization", CERT_PEN, 252, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpVia", CERT_PEN, 253, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-Forwarded-For", CERT_PEN, 254, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpRefresh", CERT_PEN, 256, FB_IE_VARLEN, NONE),
    /* http mobile fields - turned off by default */
    FB_IE_INIT("httpIMEI", CERT_PEN, 257, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpIMSI", CERT_PEN, 258, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpMSISDN", CERT_PEN, 259, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpSubscriber", CERT_PEN, 260, FB_IE_VARLEN, NONE),
    /* http extra fields - turned off by default */
    FB_IE_INIT("httpExpires", CERT_PEN, 255, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAcceptCharset", CERT_PEN, 261, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAcceptEncoding", CERT_PEN, 262, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpAllow", CERT_PEN, 263, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpDate", CERT_PEN, 264, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpExpect", CERT_PEN, 265, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpFrom", CERT_PEN, 266, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpProxyAuthentication", CERT_PEN, 267, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpUpgrade", CERT_PEN, 268, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpWarning", CERT_PEN, 269, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpDNT", CERT_PEN, 270, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-Forwarded-Proto", CERT_PEN, 271, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-Forwarded-Host", CERT_PEN, 272, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-Forwarded-Server", CERT_PEN, 273, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-DeviceID", CERT_PEN, 274, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-Profile", CERT_PEN, 275, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpLastModified", CERT_PEN, 276, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpContentEncoding", CERT_PEN, 277, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpContentLanguage", CERT_PEN, 278, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpContentLocation", CERT_PEN, 279, FB_IE_VARLEN, NONE),
    FB_IE_INIT("httpX-UA-Compatible", CERT_PEN, 280, FB_IE_VARLEN, NONE),
    /* POP3 IEs */
    FB_IE_INIT("pop3TextMessage", CERT_PEN, 124, FB_IE_VARLEN, NONE),
    /* IRC IEs */
    FB_IE_INIT("ircTextMessage", CERT_PEN, 125, FB_IE_VARLEN, NONE),
    /* TFTP IEs */
    FB_IE_INIT("tftpFilename", CERT_PEN, 126, FB_IE_VARLEN, NONE),
    FB_IE_INIT("tftpMode", CERT_PEN, 127, FB_IE_VARLEN, NONE),
    /* SLP IEs */
    FB_IE_INIT("slpVersion", CERT_PEN, 128, 1, FB_IE_F_ENDIAN),
    FB_IE_INIT("slpMessageType", CERT_PEN, 129, 1, FB_IE_F_ENDIAN),
    FB_IE_INIT("slpString", CERT_PEN, 130, FB_IE_VARLEN, NONE),
    /* FTP IEs */
    FB_IE_INIT("ftpReturn", CERT_PEN, 131, FB_IE_VARLEN, NONE),
    FB_IE_INIT("ftpUser", CERT_PEN, 132, FB_IE_VARLEN, NONE),
    FB_IE_INIT("ftpPass", CERT_PEN,133, FB_IE_VARLEN, NONE),
    FB_IE_INIT("ftpType", CERT_PEN,134, FB_IE_VARLEN, NONE),
    FB_IE_INIT("ftpRespCode", CERT_PEN,135, FB_IE_VARLEN, NONE),
    /* IMAP IEs */
    FB_IE_INIT("imapCapability", CERT_PEN, 136, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapLogin", CERT_PEN, 137, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapStartTLS", CERT_PEN, 138, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapAuthenticate", CERT_PEN, 139, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapCommand", CERT_PEN, 140, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapExists", CERT_PEN, 141, FB_IE_VARLEN, NONE),
    FB_IE_INIT("imapRecent", CERT_PEN, 142, FB_IE_VARLEN, NONE),
    /* rtsp IEs */
    FB_IE_INIT("rtspURL", CERT_PEN, 143, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspVersion", CERT_PEN, 144, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspReturnCode", CERT_PEN, 145, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspContentLength", CERT_PEN, 146, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspCommand", CERT_PEN, 147, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspContentType", CERT_PEN, 148, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspTransport", CERT_PEN, 149, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspCSeq", CERT_PEN, 150, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspLocation", CERT_PEN, 151, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspPacketsReceived", CERT_PEN, 152, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspUserAgent", CERT_PEN, 153, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtspJitter", CERT_PEN, 154, FB_IE_VARLEN, NONE),
    /* sip IEs */
    FB_IE_INIT("sipInvite", CERT_PEN, 155, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipCommand", CERT_PEN, 156, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipVia", CERT_PEN, 157, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipMaxForwards", CERT_PEN, 158, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipAddress", CERT_PEN, 159, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipContentLength", CERT_PEN, 160, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sipUserAgent", CERT_PEN, 161, FB_IE_VARLEN, NONE),
    /* smtp IEs */
    FB_IE_INIT("smtpHello", CERT_PEN, 162, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpFrom", CERT_PEN, 163, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpTo", CERT_PEN, 164, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpContentType", CERT_PEN, 165, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpSubject", CERT_PEN, 166, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpFilename", CERT_PEN, 167, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpContentDisposition", CERT_PEN, 168, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpResponse", CERT_PEN, 169, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpEnhanced", CERT_PEN, 170, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpSize", CERT_PEN, 222, FB_IE_VARLEN, NONE),
    FB_IE_INIT("smtpDate", CERT_PEN, 251, FB_IE_VARLEN, NONE),
    /* ssh IEs */
    FB_IE_INIT("sshVersion", CERT_PEN, 171, FB_IE_VARLEN, NONE),
    /* nntp IEs */
    FB_IE_INIT("nntpResponse", CERT_PEN, 172, FB_IE_VARLEN, NONE),
    FB_IE_INIT("nntpCommand", CERT_PEN, 173, FB_IE_VARLEN, NONE),
    /* dns IEs */
    ...
    FB_IE_INIT("dnsQName", CERT_PEN, 179, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsCName", CERT_PEN, 180, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsMXPreference", CERT_PEN, 181, 2, FB_IE_F_ENDIAN),
    FB_IE_INIT("dnsMXExchange", CERT_PEN, 182, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsNSDName", CERT_PEN, 183, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsPTRDName", CERT_PEN, 184, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsTTL", CERT_PEN, 199, 4, FB_IE_F_ENDIAN),
    FB_IE_INIT("dnsTXTData", CERT_PEN, 208, FB_IE_VARLEN, NONE),
    ...
    FB_IE_INIT("dnsSOAMName", CERT_PEN, 214, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsSOARName", CERT_PEN, 215, FB_IE_VARLEN, NONE),
    ...
    FB_IE_INIT("dnsSRVTarget", CERT_PEN, 219, FB_IE_VARLEN, NONE),
    ...
    FB_IE_INIT("dnsSigner", CERT_PEN, 229, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsSignature", CERT_PEN, 230, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsDigest", CERT_PEN, 231, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsPublicKey", CERT_PEN, 232, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsSalt", CERT_PEN, 233, FB_IE_VARLEN, NONE),
    FB_IE_INIT("dnsHashData", CERT_PEN, 234, FB_IE_VARLEN, NONE),
    ...
    FB_IE_INIT("sslCertSignature", CERT_PEN, 190, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSerialNumber", CERT_PEN, 244, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslObjectType", CERT_PEN, 245, 1, FB_IE_F_ENDIAN),
    FB_IE_INIT("sslObjectValue", CERT_PEN, 246, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertValidityNotBefore", CERT_PEN, 247, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertValidityNotAfter", CERT_PEN, 248, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslPublicKeyAlgorithm", CERT_PEN, 249, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslPublicKeyLength", CERT_PEN, 250, 2, FB_IE_F_ENDIAN),
    /* mysql IEs */
    FB_IE_INIT("mysqlUsername", CERT_PEN, 223, FB_IE_VARLEN, NONE),
    FB_IE_INIT("mysqlCommandCode", CERT_PEN, 224, 1, FB_IE_F_ENDIAN),
    FB_IE_INIT("mysqlCommandText", CERT_PEN, 225, FB_IE_VARLEN, NONE),
    /* dnp3.0 IEs */
    FB_IE_INIT("dnp3SourceAddress", CERT_PEN, 281, 2, FB_IE_F_ENDIAN),
    FB_IE_INIT("dnp3DestinationAddress", CERT_PEN, 282, 2, FB_IE_F_ENDIAN),
    FB_IE_INIT("dnp3Function", CERT_PEN, 283, 1, FB_IE_F_ENDIAN),
    FB_IE_INIT("dnp3ObjectData", CERT_PEN, 284, FB_IE_VARLEN, NONE),
    FB_IE_INIT("modbusData", CERT_PEN, 285, FB_IE_VARLEN, NONE),
    FB_IE_INIT("ethernetIPData", CERT_PEN, 286, FB_IE_VARLEN, NONE),
    FB_IE_INIT("rtpPayloadType", CERT_PEN, 287, 1, ER),
    FB_IE_INIT("sslRecordVersion", CERT_PEN, 288, 2, FB_IE_F_ENDIAN),
    FB_IE_NULL
};
